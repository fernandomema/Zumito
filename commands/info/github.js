...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (!args.has(0)) {return await message.reply({content: emojis.deny + 'command.github.valid_username'.trans(),allowedMentions: { repliedUser: false }});
        }
        ...
        if (git === undefined || git.name === undefined) {return await message.reply({ content: emojis.deny + 'command.github.enter_valid_user'.trans(),allowedMentions: { repliedUser: false }});
        }
